...
qrc_resources.cpp: resources.qrc \
		...
		XOPTIMUS/black_down.png \
		XOPTIMUS/state_pause.png \
		XOPTIMUS/white_down.png \
		XOPTIMUS/minus.png \
		XOPTIMUS/state_finish.png \
		XOPTIMUS/dark.css \
		XOPTIMUS/light.css \
		XOPTIMUS/optimus_paper.pdf
...
trio.o: METHODS/trio.cpp METHODS/trio.h \
		OPTIMUS/optimizer.h \
		OPTIMUS/problem.h \
		OPTIMUS/parameter.h \
		OPTIMUS/doublebox.h \
		...
		OPTIMUS/editlogger.h \
		OPTIMUS/parameterlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o trio.o METHODS/trio.cpp

BGWO.o: METHODS/BGWO.cpp METHODS/BGWO.h \
		OPTIMUS/collection.h \
		OPTIMUS/problem.h \
		OPTIMUS/optimizer.h \
		OPTIMUS/parameter.h \
		...
		OPTIMUS/editlogger.h \
		OPTIMUS/parameterlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BGWO.o METHODS/BGWO.cpp

ParallelBGwo.o: METHODS/ParallelBGwo.cpp METHODS/ParallelBGwo.h \
		OPTIMUS/optimizer.h \
		OPTIMUS/problem.h \
		OPTIMUS/parameter.h \
		OPTIMUS/doublebox.h \
		...
		OPTIMUS/editlogger.h \
		OPTIMUS/parameterlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ParallelBGwo.o METHODS/ParallelBGwo.cpp

problem1d.o: PROBLEMS/problem1d.cpp PROBLEMS/problem1d.h \
		OPTIMUS/problem.h \
		MLMODELS/mlpproblem.h \
		MLMODELS/dataset.h \
		MLMODELS/model.h \
		...
		OPTIMUS/collection.h \
		METHODS/mbfgs.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o problem1d.o PROBLEMS/problem1d.cpp
...
usersampler.o: SAMPLER/usersampler.cpp SAMPLER/usersampler.h \
		SAMPLER/problemsampler.h \
		OPTIMUS/problem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o usersampler.o SAMPLER/usersampler.cpp
