...
LINK          = g++
LFLAGS        = -O3 -Wl,-O1
LIBS          = $(SUBLIBS) -lm -fopenmp -larmadillo -ladept /usr/lib/x86_64-linux-gnu/libQt5Widgets.so /usr/lib/x86_64-linux-gnu/libQt5Gui.so /usr/lib/x86_64-linux-gnu/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
pdoublegenetic.o: METHODS/pdoublegenetic.cpp METHODS/pdoublegenetic.h \
		OPTIMUS/problem.h \
		OPTIMUS/optimizer.h \
		OPTIMUS/parameter.h \
		OPTIMUS/doublebox.h \
		...
		OPTIMUS/kmeans.h \
		OPTIMUS/cluster.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pdoublegenetic.o METHODS/pdoublegenetic.cpp

opso.o: METHODS/opso.cpp METHODS/opso.h \
		OPTIMUS/optimizer.h \
		OPTIMUS/problem.h \
		OPTIMUS/parameter.h \
		OPTIMUS/doublebox.h \
		...
		OPTIMUS/editlogger.h \
		OPTIMUS/parameterlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o opso.o METHODS/opso.cpp
...
cluster.o: OPTIMUS/cluster.cpp OPTIMUS/cluster.h \
		OPTIMUS/point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cluster.o OPTIMUS/cluster.cpp

kmeans.o: OPTIMUS/kmeans.cpp OPTIMUS/kmeans.h \
		OPTIMUS/cluster.h \
		OPTIMUS/point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o kmeans.o OPTIMUS/kmeans.cpp

point.o: OPTIMUS/point.cpp OPTIMUS/point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o point.o OPTIMUS/point.cpp
