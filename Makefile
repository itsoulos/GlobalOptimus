...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		MLMODELS/functionalrbf.h METHODS/adam.cpp \
		METHODS/ipso.cpp \
		METHODS/lbfgs.cpp \
		METHODS/neldermead.cpp \
		METHODS/neuralminimizer.cpp \
