...
The above techniques present various problems that had to be addressed
by the researchers, such as, for example, the initialization of the
possible solutions, the termination rules, etc. A number of researchers
have dealt with the topic of initialization of candidate solutions
and have proposed techniques such, as the repulsion method \citep{ms_repulsion},
an adaptive sampling method using the Kriging model \citep{sample_kringing},
Monte Carlo based sampling methods \citep{sample_monte}, a method
which utilizes an Radial Basis Function (RBF) network \citep{rbf1}
to obtain samples \citep{rbf_sample} etc. Additionally, in the direction
of termination methods, a series of techniques have been proposed,
such as sequential stopping rules \citep{ms_seq}, a stopping rule
based on asymptotic considerations \citep{doublepop_tsoulos}, a stopping
rule that utilizes the likelihood of obtaining the specific set of
solutions \citep{stop_likehood} etc.
...
\[
f(x)=\sum_{i=1}^{11}\left(a_{i}-\frac{x_{1}\left(b_{1}^{2}+b_{i}x_{2}\right)}{b_{1}^{2}+b_{i}x_{3}+x_{4}}\right)^{2}
\]
...
\hline 
BF3 & 1863 & 1366 & 1408\tabularnewline
\hline 
...
\hline 
EXTENDEDF10 & 1812 & 1360 & 1361\tabularnewline
\hline 
F12 & 6085 & 4196 & 4340\tabularnewline
\hline 
F14 & 2225 & 1691 & 1617\tabularnewline
\hline 
F15 & 1950 & 1512 & 1620\tabularnewline
\hline 
F17 & 1932 & 1424 & 1438\tabularnewline
\hline 
...
\hline 
SPHERE & 1533 & 1033 & 1199\tabularnewline
\hline 
SCHWEFEL & 1635 & 1139 & 1242\tabularnewline
\hline 
SCHWEFEL2.21 & 1724 & 1230 & 1286\tabularnewline
\hline 
SCHWEFEL2.22 & 8363 & 8663 & 5309\tabularnewline
\hline 
...
\end{figure}
 Moreover, a scatter plot representation of the used Distributions
with Kruskal-Wallis Ranking is depicted in Figure \ref{fig:ttest2}.
...
\end{figure}
In this test, the p-value remains very low at any level of significance.
Consequently, the null hypothesis is rejected, indicating that the
experimental tests are statistically significant.
