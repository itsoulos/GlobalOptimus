...
to a multitude of real-world problems and hence a variety of computational
techniques have been developed to efficiently locate it. Among these
techniques, evolutionary techniques play a central role, which seek,
through the imitation of natural processes, to efficiently obtain
the global minimum of multidimensional functions. An evolutionary
...
methods do not guarantee finding the global minimum and are mainly
...
methods based on the Multistart technique \citep{mult_minfinder,mult_cfo}
...
\textcolor{red}{The above techniques present various problems that
had to be addressed by the researchers, such as, for example, the
initialization of the possible solutions, the termination rules, etc.
A number of researchers have dealt with the topic of initialization
of candidate solutions and have proposed techniques such, as the repulsion
method \citep{ms_repulsion}, an adaptive sampling method using the
Kriging model \citep{sample_kringing}, Monte Carlo based sampling
methods \citep{sample_monte}, a method which utilizes an Radial Basis
Function (RBF) network \citep{rbf1} to obtain samples \citep{rbf_sample}
etc. Additionally, in the direction of termination methods, a series
of techniques have been proposed, such as sequential stopping rules
\citep{ms_seq}, a stopping rule based on asymptotic considerations
\citep{doublepop_tsoulos}, a stopping rule that utilizes the likelihood
of obtaining the specific set of solutions \citep{stop_likehood}
etc.}
...
\]
\item \textbf{\textcolor{red}{Bf3}}\textcolor{red}{{} (Bohachevsky 3) function:
}
\[
...
\item \textbf{\textcolor{red}{ExtendedF10 }}\textcolor{red}{function:}
\[
f(x)=\sum_{i=1}^{n}\left(x_{i}^{2}-10\cos\left(2\pi x_{i}\right)\right)
\]
\item \textbf{\textcolor{red}{F12 }}\textcolor{red}{function:}
\begin{align*}
...
\item \textbf{\textcolor{red}{Sphere }}\textcolor{red}{function:}
\[
f(x)=\sum_{i=1}^{n}x_{i}^{2}
\]
\item \textbf{\textcolor{red}{Schwefel }}\textcolor{red}{function}\textbf{\textcolor{red}{:}}\textbf{
\[
f(x)=\sum_{i=1}^{n}\left(\sum_{j=1}^{i}x_{j}\right)^{2}
\]
}
\item \textbf{\textcolor{red}{Schwefel 2.21 }}\textcolor{red}{function:}
\[
f(x)=418.9829n+\sum_{i=1}^{n}-x_{i}\sin\left(\sqrt{\left|x_{i}\right|}\right)
\]
\item \textbf{\textcolor{red}{Schwefel 2.22 }}\textcolor{red}{function:}
\[
...
are shown in Table \ref{tab:expSettings}. Generally, the region of
attraction $A\left(x^{*}\right)$ of a local minimum $x^{*}$ is defined
as:
\begin{equation}
...
\hline 
\hline 
ACKLEY & 16754 & 24518 & 1346\tabularnewline
\hline 
BF1 & 10466 & 9912 & 1856\tabularnewline
\hline 
BF2 & 10059 & 9364 & 1738\tabularnewline
\hline 
BF3 & 7290 & 9847 & 1408\tabularnewline
\hline 
...
\hline 
EXTENDEDF10 & 10739 & 14363 & 1361\tabularnewline
\hline 
F12 & 31277 & 23705 & 4340\tabularnewline
\hline 
F14 & 14598 & 26296 & 1617\tabularnewline
\hline 
F15 & 8215 & 13599 & 1620\tabularnewline
\hline 
F17 & 9202 & 11851 & 1438\tabularnewline
\hline 
...
\hline 
SPHERE & 3942 & 8330 & 1199\tabularnewline
\hline 
SCHWEFEL & 4688 & 9037 & 1242\tabularnewline
\hline 
SCHWEFEL2.21 & 6233 & 7872 & 1286\tabularnewline
\hline 
SCHWEFEL2.22 & 81980 & 88227 & 5309\tabularnewline
\hline 
...
\hline 
\textbf{SUM} & \textbf{651203} & \textbf{564846} & \textbf{91409}\tabularnewline
\hline 
\end{tabular}
\end{table}
A statistical comparison of these results is also outlined in Figure
\ref{fig:statCalls}. 
...
computing time for finding the global minimum. Also, a scatter plot
for the used optimization methods is shown in Figure \ref{fig:ttest1},
which also depicts the superiority of the current method.
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.4]{ttest1}
\par\end{centering}
\caption{Scatter Plot Representation of Optimization Methods with Kruskal-Wallis
Ranking\label{fig:ttest1}}
\end{figure}

Furthermore, an additional experiment was done in order to measure
the importance of the K-means sampling in the proposed method. In
this test, 3 different sampling methods were used in the proposed
method:
\begin{enumerate}
...
\hline 
\hline 
ACKLEY & 1803 & 1330 & 1346\tabularnewline
\hline 
BF1 & 2637 & 2146 & 1856\tabularnewline
\hline 
BF2 & 2470 & 2011 & 1738\tabularnewline
\hline 
\textcolor{red}{BF3} & \textcolor{red}{1863} & \textcolor{red}{1366} & \textcolor{red}{1408}\tabularnewline
\hline 
...
\hline 
\textcolor{red}{EXTENDEDF10} & \textcolor{red}{1812} & \textcolor{red}{1360} & \textcolor{red}{1361}\tabularnewline
\hline 
\textcolor{red}{F12} & \textcolor{red}{6085} & \textcolor{red}{4196} & \textcolor{red}{4340}\tabularnewline
\hline 
\textcolor{red}{F14} & \textcolor{red}{2225} & \textcolor{red}{1691} & \textcolor{red}{1617}\tabularnewline
\hline 
\textcolor{red}{F15} & \textcolor{red}{1950} & \textcolor{red}{1512} & \textcolor{red}{1620}\tabularnewline
\hline 
\textcolor{red}{F17} & \textcolor{red}{1932} & \textcolor{red}{1424} & \textcolor{red}{1438}\tabularnewline
\hline 
...
\hline 
\textcolor{red}{SPHERE} & \textcolor{red}{1533} & \textcolor{red}{1033} & \textcolor{red}{1199}\tabularnewline
\hline 
\textcolor{red}{SCHWEFEL} & \textcolor{red}{1635} & \textcolor{red}{1139} & \textcolor{red}{1242}\tabularnewline
\hline 
\textcolor{red}{SCHWEFEL2.21} & \textcolor{red}{1724} & \textcolor{red}{1230} & \textcolor{red}{1286}\tabularnewline
\hline 
\textcolor{red}{SCHWEFEL2.22} & \textcolor{red}{8363} & \textcolor{red}{8663} & \textcolor{red}{5309}\tabularnewline
\hline 
...
\hline 
\textbf{SUM} & \textbf{124837} & \textbf{102636} & \textbf{91309}\tabularnewline
\hline 
\end{tabular}
\end{table}
...
\end{figure}
 \textcolor{red}{Moreover, a scatter plot representation of the used
Distributions with Kruskal-Wallis Ranking is depicted in Figure \ref{fig:ttest2}}.

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.4]{ttest2}
\par\end{centering}
\caption{Scatter Plot Representation of the used Distributions with Kruskal-Wallis
Ranking.\label{fig:ttest2}}

\end{figure}
\textcolor{red}{In this test, the p-value remains very low at any
level of significance. Consequently, the null hypothesis is rejected,
indicating that the experimental tests are statistically significant.}
...
\bibitem{ms_repulsion}A.E. Sepulveda, L. Epstein, The repulsion algorithm,
a new multistart method for global optimization, Structural Optimization
\textbf{11}, pp. 145--152, 1996.

\bibitem{sample_kringing}Z. Chen, H. Qiu, L. Gao et al, A local adaptive
sampling method for reliability-based design optimization using Kriging
model, Struct Multidisc Optim \textbf{49}, pp. 401--416, 2014. 

\bibitem{sample_monte}T.H.-de-Mello,G. Bayraksan, Monte Carlo sampling-based
methods for stochastic optimization, Surveys in Operations Research
and Management Science \textbf{19}, pp. 56-85, 2014.

\bibitem{rbf1}J. Park, I. W. Sandberg, Universal Approximation Using
Radial-Basis-Function Networks, Neural Computation \textbf{3}, pp.
246-257, 1991.

\bibitem{rbf_sample}I.G. Tsoulos, A. Tzallas, D. Tsalikakis, Use
RBF as a Sampling Method in Multistart Global Optimization Method,
Signals \textbf{ 3}, pp. 857-874, 2022.

\bibitem{ms_seq}W.E. Hart, Sequential stopping rules for random optimization
...
\bibitem{stop_likehood}M. Ohsaki, M. Yamakawa, Stopping rule of multi-start
local search for structural optimization, Struct Multidisc Optim \textbf{57},
pp. 595--603, 2018.
...
\bibitem{testfunctions5}A. LaTorre, D. Molina, E. Osaba, J. Poyatos,
J. Del Ser, F. Herrera, A prescription of methodological guidelines
for comparing bio-inspired optimization algorithms, Swarm and Evolutionary
