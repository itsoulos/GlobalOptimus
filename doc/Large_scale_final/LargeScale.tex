...
\begin{figure}
\centering{}\includegraphics{diagramma}\caption{The steps of the proposed DE algorithm.\label{fig:The-steps-of}}
\end{figure}
...
Table \ref{fig:Sensitivity-of-function} illustrates the sensitivity
...
Table \ref{fig:Sensitivity-of-function-1} presents the effect of
