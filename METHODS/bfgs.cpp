...
void    Bfgs::init()
{
    ...
    iact=new long[3*n];
    par=new double[n];
    myProblem->getleftmargin(xl);
    myProblem->getrightmargin(xu);
    */
}
...
void    Bfgs::step()
{
    ...
    long nact;
    long iprint=0;
    long info=getParam("bfgs_iters").getValue().toInt();
    long m=0;
    long meq=0;
    long ia=n;
...
void    Bfgs::setPoint(Data &x,double &y)
{
...
int Bfgs::getmin_(integer *n, integer *m, integer *meq, double
...
int  Bfgs::initzu_(integer *n, integer *m, double *xl,
...
int Bfgs::ktvec_(integer *n, integer *m, double *a, integer *
...
int  Bfgs::lsrch_(integer *n, double *x, double *g,
...
int Bfgs::minflc_(integer *n, integer *m, integer *meq, double
    *a, integer *ia, double *b, double *xl, double *xu,
    double *x, double *acc, integer *iact, integer *nact,
...
int Bfgs::minfun_(integer *n, integer *m, double *a, integer *
...
int Bfgs::newcon_(integer *n, integer *m, double *a, integer *
...
int Bfgs::satact_(integer *n, integer *m, double *a, integer *
    ia, double *b, double *xl, double *xu, double *x,
...
int Bfgs::sdegen_(integer *n, integer *m, double *a, integer *
...
int Bfgs::sdirn_(integer *n, integer *nact, double *z__,
...
int Bfgs::stepbd_(integer *n, integer *m, double *a, integer *
...
int Bfgs::zbfgs_(integer *n, double *x, integer *nact,
...
/*
double Bfgs(Data &x, Problem *p,int iters)
{
    double fmin;
    oldmin=1e+100;
    totcal_1.itnocs =0 ;
...
int Bfgs::getfes_(integer *n, integer *m, double *a, integer *
    ia, double *b, double *xl, double *xu, double *x,
...
int Bfgs::addcon_(integer *n, integer *m, double *a, integer *
    ia, integer *iact, integer *nact, double *z__, double *u,
...
int Bfgs::adjtol_(integer *n, integer *m, double *a, integer *
    ia, double *b, double *xl, double *xu, double *x,
...
int Bfgs::conres_(integer *n, integer *m, double *a, integer *
    ia, double *b, double *xl, double *xu, double *x,
...
int Bfgs::delcon_(integer *n, integer *m, double *a, integer *
    ia, integer *iact, integer *nact, double *z__, double *u,
...
int Bfgs::eqcons_(integer *n, integer *m, integer *meq, double
...
int Bfgs::getd_(integer *n, integer *m, double *a, integer *ia,
     integer *iact, integer *nact, double *par, double *g,
