#Available optimization methods: Opso,GradientDescent,Adam,Bfgs,Lbfgs,NelderMead,Genetic,Multistart,iPso,NeuralMinimizer,DifferentialEvolution, ParallelDe, Simman, Trident
METHOD=Genetic
...
PAGENTS=`expr $TOTAL_AGENTS/$THREADS | bc `
 METHODPARAMS="--pgen_chromosomes=$PAGENTS --pgen_generations=500 --pgen_selectionrate=0.1 --pgen_mutationrate=0.05 --pgen_localsearchrate=0.00 --pgen_subCluster=$THREADS --pgen_subClusterEnable=1 --pgen_centers=20 --pgen_pNumber=5 --pgen_parallelPropagateMethod=NtoN --opt_distpartitions=$THREADS"
  ...
  METHODPARAMS="--gen_lrate=0.000 --gen_srate=0.1 --gen_mrate=0.05 --gen_tsize=8 --gen_selection=tournament --gen_crossover=double --gen_mutation=double --gen_count=500 --gen_maxiters=500 --gen_lsearchmethod=none --gen_lsearchgens=10 --gen_lsearchitems=20"
