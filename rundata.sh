...
then
	MODELPARAMS="--model_trainfile=$DATAPATH/$1.train --model_testfile=$DATAPATH/$1.test --rule_popcount=500 --rule_popsize=200 --rule_popgens=500 --rule_popsrate=0.1 --rule_popmrate=0.05 --rule_lsearchiters=10 --rule_lsearchitems=20 --nnc_lsearchmethod=crossover"
elif [ $MODEL = "nnc" ]
then
