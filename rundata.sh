...
then
	MODELPARAMS="--model_trainfile=$DATAPATH/$1.train --model_testfile=$DATAPATH/$1.test --nnc_popcount=500 --nnc_popsize=500 --nnc_popgens=500 --nnc_popsrate=0.1 --nnc_popmrate=0.05 --nnc_lsearchrate=0.000 --nnc_lsearchmethod=bfgs --nnc_crossitems=10 --nnc_lsearchiters=0 --nnc_lsearchitems=20 --nnc_steadystate=yes"
fi
